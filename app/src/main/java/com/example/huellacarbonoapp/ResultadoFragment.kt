...
class ResultadoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnInicio = view.findViewById<Button>(R.id.btnInicioResultado)

        val totalCO2 = args.totalC02

        txtResultado.text = "Huella de carbono: %.2f kg de CO₂".format(totalCO2)

        btnInicio.setOnClickListener {
            findNavController().navigate(
                R.id.action_resultadoFragment_to_inicioFragment
            )
        }
    }
